...
Next, we want to send a simple ***SYN*** packet to the port in order to recieve the ***SYN/ACK*** packet. To do this, we must be able to construct such a packet ourselves.
